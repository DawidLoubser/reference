...
@ManagedBean
@RequestScoped
public class DatePeriodBackingBean implements Serializable
{
	public DatePeriodBackingBean() {}
	...
	private Logger logger = Logger.getLogger(DatePeriodBackingBean.class.getName());
}
