...
@RequestScoped
public class LocationSelectorBackingBean implements Serializable
{
	...
	private static Logger logger = Logger.getLogger(LocationSelectorBackingBean.class.getName());
}
