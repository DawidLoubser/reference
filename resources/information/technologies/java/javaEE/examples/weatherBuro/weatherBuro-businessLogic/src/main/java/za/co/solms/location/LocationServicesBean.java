...
@Stateless
@WebService(endpointInterface = "za.co.solms.location.LocationServices",serviceName="LocationService")
public class LocationServicesBean implements LocationServices
{
	...
	/* (non-Javadoc)
	 * @see solms.co.za.location.LocationServices#getAllLocationNames()
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<String> getAllLocationNames()
	{
		...
		Query query = entityManager.createNamedQuery("findAllLocationNames");
