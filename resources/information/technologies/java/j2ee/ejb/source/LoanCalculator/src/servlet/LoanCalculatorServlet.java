...
{
   private LoanCalculatorLocalHome loanCalculatorLocalHome = null;
   ...
   public void init() throws ServletException
   {
      try
      {
         ...
         loanCalculatorLocalHome = (LoanCalculatorLocalHome)jndiContext.lookup(jndiName);
      }
      catch(Exception e)
      {
      ...
      throws ServletException, IOException
   {
      ...
      try
      {
         LoanCalculatorLocal loanCalculatorBean = loanCalculatorLocalHome.create();
   ...
   private boolean calculate(LoanCalculatorLocal loanCalculatorBean,
   ...
   private static final String jndiName = "java:comp/env/ejb/LoanCalculatorLocal";
