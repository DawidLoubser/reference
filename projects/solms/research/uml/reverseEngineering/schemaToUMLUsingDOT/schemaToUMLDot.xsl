...
<!-- This is a simple style sheet that reverse-engineers a Schema to generate a UML diagram,
    by rendering to the 'dot' hierarchical graph format.
    .
    ...
    @version 0.0.3 alpha (24 May 2006)
-->
...
<xsl:stylesheet 
    ...
    <xsl:template match="xs:schema" xml:space="preserve"> <!-- TODO: First render *imported* schemas! -->
digraph G
{
        nodesep = 1.5;
    ...
    <!-- Template to print the local name of a (potentially qualified) name -->
