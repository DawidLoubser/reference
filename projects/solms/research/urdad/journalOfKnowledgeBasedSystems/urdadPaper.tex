...
\begin{figure}
  \centering
  \epsfig{file=designActivities.eps, scale=0.8}
...
\begin{figure}
  \centering
  \epsfig{file=methodology.eps, scale=0.8}
...
\begin{figure}
  \centering
  \epsfig{file=provideLoanFunctionalRequirements.eps, scale=0.8}
...
\begin{figure}
  \centering
  \epsfig{file=provideLoanUserWorkflow.eps, scale=0.8}
...
\begin{figure}
  \centering
  \epsfig{file=provideLoanContract.eps, scale=0.8}
...
\begin{figure}
  \centering
  \epsfig{file=provideLoanResponsibilityAllocation.eps, scale=0.8}
...
\begin{figure}
  \centering
  \epsfig{file=provideLoanSuccessScenario.eps, scale=0.8}
...
\begin{figure}
  \centering
  \epsfig{file=provideLoanBusinessProcess.eps, scale=0.8}
...
\begin{figure}
  \centering
  \epsfig{file=provideLoanCollaborationContext.eps, scale=0.8}
...
\begin{figure}
  \centering
  \epsfig{file=assessLoanRiskFunctionalRequirements.eps, scale=0.8}
